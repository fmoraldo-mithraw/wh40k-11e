...
② AMÉLIORATIONS MFM SANS ENTRÉE BDD — envoie le nom exact en base, ou confirme qu'elle manque dans les données.  [37]
   ...
   • [Blood Angels] Sanguinary Tear (RAGE-CURSED ONSLAUGHT) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Slaughterthirst (BLOOD LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Dreaming Crown (LEGION OF EXCESS) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] False Majesty (LEGION OF EXCESS) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Cankerblight (PLAGUE LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Droning Shroud (PLAGUE LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Font of Spores (PLAGUE LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Improbable Shield (SCINTILLATING LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Daemons] Mantle of Gloom (SHADOW LEGION) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Knights] Final Howl (HOUNDPACK LANCE) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Knights] Cruel Lashmaster (Aura) (ICONOCLAST FIEFDOM) — aucune amélioration bdd pour ce nom MFM
   • [Chaos Knights] Iconoclast Idol (Aura) (ICONOCLAST FIEFDOM) — aucune amélioration bdd pour ce nom MFM
   • [Dark Angels] Astartes Tank Ace (HEADHUNTER TASK FORCE) — aucune amélioration bdd pour ce nom MFM
   • [Dark Angels] Pennant of Remembrance (UNFORGIVEN TASK FORCE) — aucune amélioration bdd pour ce nom MFM
   • [Deathwatch] Astartes Tank Ace (HEADHUNTER TASK FORCE) — aucune amélioration bdd pour ce nom MFM
   ...
   • [Space Marines] Astartes Tank Ace (HEADHUNTER TASK FORCE) — aucune amélioration bdd pour ce nom MFM
   • [Space Marines] Avenging Avatar (RECLAMATION FORCE) — aucune amélioration bdd pour ce nom MFM
   • [Space Wolves] Astartes Tank Ace (HEADHUNTER TASK FORCE) — aucune amélioration bdd pour ce nom MFM
   • [Thousand Sons] Arcane Thralls (RUBRICAE PHALANX) — aucune amélioration bdd pour ce nom MFM
   • [Tyranids] Biophagic Flow (ASSIMILATION SWARM) — aucune amélioration bdd pour ce nom MFM
...
③ COÛT DE CHAPITRE (datasheet partagée, prix divergent) — confirme les prix par chapitre : j'encode un modifier primary-catalogue.  [15]
   ...
   • [Blood Angels] BLADEGUARD VETERAN SQUAD — datasheet partagée, prix divergent selon la faction (bdd 80 → MFM 85)
   • [Blood Angels] BLADEGUARD VETERAN SQUAD — paliers divergents selon la faction (MFM [170] non produits par la bdd [80,160])
   • [Blood Angels] CAPTAIN WITH JUMP PACK — datasheet partagée, prix divergent selon la faction (bdd 75 → MFM 80)
   • [Blood Angels] CHAPLAIN WITH JUMP PACK — datasheet partagée, prix divergent selon la faction (bdd 75 → MFM 80)
   • [Blood Angels] REPULSOR EXECUTIONER — datasheet partagée, prix divergent selon la faction (bdd 255 → MFM 230)
...
④ COÛT PORTÉ PAR LES MODÈLES (unité à 0, prix sur les modèles) — confirme le barème par modèle de composition.  [10]
   ...
   • [Dark Angels] FIRESTRIKE SERVO-TURRETS — coût unité 0 (probablement porté par les modèles de composition), MFM base=75
   • [Deathwatch] FIRESTRIKE SERVO-TURRETS — coût unité 0 (probablement porté par les modèles de composition), MFM base=75
   • [Necrons] LOKHUST HEAVY DESTROYERS — coût unité 0 (probablement porté par les modèles de composition), MFM base=50
...
⑤ PRIX À COMPOSITION (tailles spéciales : Runtherds…) — le barème MFM est donné ci-dessous, confirme l'encodage voulu.  [10]
   ...
   • [Black Templars] OUTRIDER SQUAD — composition (taille non « N model ») — barème MFM: 3 models=70, 6 models=140, + 1 Invader ATV=60
   ...
   • [Orks] GRETCHIN — composition (taille non « N model ») — barème MFM: 10 Gretchin=45, 1 Runtherd, 10 Gretchin=45, 20 Gretchin=80, 1 Runtherd, 20 Gretchin=85, 2 Runtherd, 20 Gretchin=90
